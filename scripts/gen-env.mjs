...
write("dashboard-api", {
  ...
  GOOGLE_ADS_CONVERSION_ACTION_ID_CHECKOUT: E.GOOGLE_ADS_CONVERSION_ACTION_ID_CHECKOUT,
  ...
  ANALYTICS_EXCLUDE_EMAILS: E.ANALYTICS_EXCLUDE_EMAILS,
  ANALYTICS_EXCLUDE_USER_IDS: E.ANALYTICS_EXCLUDE_USER_IDS,
  INGEST_SHARED_SECRET: E.INGEST_SHARED_SECRET,
