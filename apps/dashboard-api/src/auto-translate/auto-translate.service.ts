...
export class AutoTranslateService {
  ...
  private async translateKeyedBatch(
    ...
    const prompt = [
      ...
      "- ALWAYS translate generic dish names, ingredients and food terms into the target language, even when written in capital letters (e.g. \"BIFE A PORTUGUESA\" must be translated, not kept as-is).",
      "- Preserve ONLY real brand names and proper nouns as-is (e.g. Coca-Cola, 7UP, Fanta, specific wine/spirit labels). When unsure whether a word is a brand or a food term, translate it.",
