...
// online and still treats BASIC as paid. Keep the two separate: BASIC keeps
// its menu online but loses the operational (PRO) features — orders / kitchen
// / reservations gate on this flag.
