...
export const WELCOME_PERSONAL: Record<string, T> = {
  ar: {
    ...
    help: "إذا كانت لديك أي أسئلة حول إعداد قائمة QR أو الموقع أو الحجوزات أو أي شيء آخر — ما عليك سوى الرد على هذا البريد الإلكتروني. أنا هنا للمساعدة.",
  ...
  ca: {
    ...
    greeting: "Hola!",
    body: "Soc en Bogdan i m'encarregaré del teu compte a IQ Rest.",
    cta: "Obrir el panell",
    help: "Si tens preguntes sobre la configuració del menú QR, lloc web, reserves o qualsevol altra cosa — simplement respon a aquest correu. Soc aquí per ajudar-te.",
  ...
  el: {
    subject: "Καλώς ήρθες στο IQ Rest",
    greeting: "Γεια σου!",
    body: "Είμαι ο Bogdan και θα φροντίζω τον λογαριασμό σου στο IQ Rest.",
    cta: "Άνοιγμα πίνακα",
    help: "Αν έχεις ερωτήσεις σχετικά με τη ρύθμιση του QR μενού, της ιστοσελίδας, των κρατήσεων ή οτιδήποτε άλλο — απλώς απάντησε σε αυτό το email. Είμαι εδώ για να βοηθήσω.",
  ...
  ga: {
    subject: "Fáilte go dtí IQ Rest",
    greeting: "Dia duit!",
    body: "Is mise Bogdan, agus beidh mé ag tabhairt aire do do chuntas ag IQ Rest.",
    cta: "Oscail an deais",
    help: "Má tá aon cheist agat faoi do roghchlár QR, suíomh gréasáin, áirithintí nó aon rud eile a shocrú — freagair an ríomhphost seo. Tá mé anseo chun cabhrú leat.",
    closing: "Ag tnúth le bheith ag obair leat!",
  },
  hr: {
    subject: "Dobrodošli u IQ Rest",
    greeting: "Pozdrav!",
    body: "Ja sam Bogdan i brinut ću se o vašem računu na IQ Rest.",
    cta: "Otvori panel",
  ...
  hu: {
    subject: "Üdvözlünk az IQ Restnél",
    greeting: "Szia!",
  ...
  ja: {
    ...
    closing: "ご一緒にお仕事ができることを楽しみにしております！",
  },
  ko: {
  ...
  pl: {
    ...
    cta: "Otwórz panel",
    help: "Jeśli masz pytania dotyczące konfiguracji menu QR, strony internetowej, rezerwacji lub czegokolwiek innego — po prostu odpowiedz na ten e-mail. Jestem tu, aby pomóc.",
    closing: "Nie mogę się doczekać naszej współpracy!",
  },
  pt: {
  ...
  ro: {
    subject: "Bine ai venit la IQ Rest",
    greeting: "Salut!",
  ...
  sr: {
    subject: "Dobrodošli u IQ Rest",
    greeting: "Zdravo!",
    body: "Ja sam Bogdan i brinuću o vašem nalogu na IQ Rest.",
    cta: "Otvori panel",
    help: "Ako imate pitanja o podešavanju QR menija, veb sajta, rezervacija ili bilo čega drugog — jednostavno odgovorite na ovaj imejl. Tu sam da pomognem.",
    closing: "Radujem se saradnji!",
  },
  sv: {
  ...
  tr: {
    ...
    greeting: "Merhaba!",
    body: "Ben Bogdan, IQ Rest'teki hesabınızla ben ilgileneceğim.",
    cta: "Paneli aç",
  ...
  zh: {
    ...
    cta: "打开控制台",
    help: "如果您在设置 QR 菜单、网站、预订或其他任何方面有疑问，回复此邮件即可。我随时为您提供帮助。",
    closing: "期待与您合作！",
  },
};
