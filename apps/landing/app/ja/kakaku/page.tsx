...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Proでは何店舗まで管理できますか?", a: "Proは1つのアカウントで最大4店舗を含み、すべて単一のダッシュボードから管理できます。より大きなグループを運営していますか?EnterpriseプランについてはWhatsAppでお気軽にご連絡ください。" },
