...
export const TEXTS: LandingTexts = {
  ...
  pricingQuiz: {
    heading: "プランを作成",
    sub: "使う分だけお支払い。メニューから始めて、必要な機能を追加できます。",
    billingLabel: "請求:",
    monthly: "月額",
    yearly: "年額",
    ...
    menuTitle: "デジタルメニュー",
    menuHint: "常に含まれます",
    reservationsTitle: "予約",
    reservationsHint: "テーブル予約",
    kdsTitle: "キッチンディスプレイ",
    kdsHint: "キッチン画面に表示される注文",
    domainTitle: "カスタムドメイン",
    domainHint: "独自のウェブアドレス",
    perMonthSuffix: "/月",
    perYearSuffix: "/年",
    perMonthLongSuffix: "/月",
    saveYearlyTemplate: "年額請求で年間 {amount} 節約",
    volumeDiscountTemplate: "{percent}% ボリューム割引 · {count} 店舗",
    saveUpToHint: "5店舗以上で最大50%節約",
    billedYearly: "年に1回請求",
    billedMonthly: "毎月請求",
    enterprisePre: "カスタムプランやレストランの追加が必要ですか?",
    enterpriseCta: "お問い合わせ",
    enterprisePost: "最適なプランをご提案します。",
    enterpriseWa: "こんにちは！レストラン向けのカスタムプランを希望します。",
  },

  pricingCta: {
    heading: "シンプルで柔軟な料金",
    sub: "必要な機能だけにお支払い — 1分で自分だけのプランを作成。",
    fromTemplate: "{price}/月〜",
    button: "プランを計算",
  },
