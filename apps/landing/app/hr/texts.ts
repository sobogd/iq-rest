...
export const TEXTS: LandingTexts = {
  ...
  pricingQuiz: {
    heading: "Sastavite svoj plan",
    sub: "Plaćajte samo ono što koristite. Počnite s jelovnikom i dodajte što vam treba.",
    ...
    menuTitle: "Digitalni jelovnik",
    menuHint: "Uvijek uključeno",
    reservationsTitle: "Rezervacije",
    reservationsHint: "Rezervacije stolova",
    kdsTitle: "Kuhinjski zaslon",
    kdsHint: "Narudžbe na kuhinjskom zaslonu",
    domainTitle: "Vlastita domena",
    domainHint: "Vaša vlastita web-adresa",
    perMonthSuffix: "/mj",
    perYearSuffix: "/god",
    perMonthLongSuffix: "/mjesec",
    saveYearlyTemplate: "Uštedite {amount} godišnje uz godišnju naplatu",
    volumeDiscountTemplate: "{percent}% količinski popust · {count} restorana",
    saveUpToHint: "Uštedite do 50% uz 5+ restorana",
    billedYearly: "Naplaćeno jednom godišnje",
    billedMonthly: "Naplaćeno mjesečno",
    enterprisePre: "Trebate prilagođeni plan ili više restorana?",
    enterpriseCta: "Javite nam se",
    enterprisePost: "i prilagodit ćemo ga za vas.",
    enterpriseWa: "Bok! Želio bih prilagođeni plan za svoje restorane.",
  },

  pricingCta: {
    heading: "Jednostavne, fleksibilne cijene",
    sub: "Plaćajte samo za značajke koje trebate — sastavite vlastiti plan u minuti.",
    fromTemplate: "od {price}/mj",
