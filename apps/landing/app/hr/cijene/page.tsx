...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Koliko restorana mogu upravljati uz Pro?", a: "Pro uključuje do 4 restorana pod jednim računom, svi se upravljaju iz jedne nadzorne ploče. Vodite veću grupu? Pišite nam na WhatsApp o Enterprise planu." },
