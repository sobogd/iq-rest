...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Πόσα εστιατόρια μπορώ να διαχειρίζομαι με το Pro;", a: "Το Pro περιλαμβάνει έως 4 εστιατόρια σε έναν λογαριασμό, όλα διαχειριζόμενα από ένα ενιαίο πάνελ. Διαχειρίζεστε μεγαλύτερο όμιλο; Στείλτε μας μήνυμα στο WhatsApp για ένα πλάνο Enterprise." },
