...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Скількома ресторанами я можу керувати на Pro?", a: "Pro включає до 4 ресторанів під одним акаунтом, усіма Ви керуєте з єдиної панелі адміністрування. Керуєте більшою мережею? Напишіть нам у WhatsApp про план Enterprise." },
