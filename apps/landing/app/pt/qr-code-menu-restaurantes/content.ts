...
export const CONTENT: FeatureContent = {
  ...
  trackPrefix: "l_pt_qr",
  featureHeading: {
    heading: "Mais do que um QR code",
    sub: "Tudo aquilo em que uma única leitura se transforma para os seus clientes e a sua sala.",
  },
  ...
  hero: {
    headline: "Menu QR:\naponte e peça.",
    cta: "Criar menu QR",
    sub: "O cliente lê o QR da mesa, vê fotos e alergénios em 35 idiomas e pede — sem apps nem reimpressões.",
  },
