...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Quantos restaurantes posso gerir no Pro?", a: "O Pro inclui até 4 restaurantes numa só conta, todos geridos a partir de um único painel. Tens um grupo maior? Envia-nos uma mensagem no WhatsApp sobre um plano Enterprise." },
