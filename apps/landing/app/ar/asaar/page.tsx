...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "كم عدد المطاعم التي يمكنني إدارتها في Pro؟", a: "تتضمن Pro حتى 4 مطاعم ضمن حساب واحد، تُدار جميعها من لوحة إدارة واحدة. تدير مجموعة أكبر؟ راسلنا على WhatsApp بخصوص خطة Enterprise." },
