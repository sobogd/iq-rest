...
export const TEXTS: LandingTexts = {
  ...
  pricingQuiz: {
    heading: "Construiți-vă planul",
    sub: "Plătiți doar pentru ce folosiți. Începeți cu meniul și adăugați ce aveți nevoie.",
    billingLabel: "Facturare:",
    monthly: "Lunar",
    yearly: "Anual",
    restaurantsLabel: "Restaurante:",
    fewerAria: "Mai puține restaurante",
    moreAria: "Mai multe restaurante",
    menuTitle: "Meniu digital",
    menuHint: "Întotdeauna inclus",
    reservationsTitle: "Rezervări",
    reservationsHint: "Rezervări de mese",
    kdsTitle: "Ecran de bucătărie",
    kdsHint: "Comenzi pe un ecran de bucătărie",
    domainTitle: "Domeniu personalizat",
    domainHint: "Adresa dvs. web proprie",
    perMonthSuffix: "/lună",
    perYearSuffix: "/an",
    perMonthLongSuffix: "/lună",
    saveYearlyTemplate: "Economisiți {amount} pe an cu facturare anuală",
    volumeDiscountTemplate: "{percent}% reducere de volum · {count} restaurante",
    saveUpToHint: "Economisiți până la 50% cu 5+ restaurante",
    billedYearly: "Facturat o dată pe an",
    billedMonthly: "Facturat lunar",
    enterprisePre: "Aveți nevoie de un plan personalizat sau de mai multe restaurante?",
    enterpriseCta: "Contactați-ne",
    enterprisePost: "și îl vom adapta pentru dvs.",
    enterpriseWa: "Salut! Aș dori un plan personalizat pentru restaurantele mele.",
  },

  pricingCta: {
    heading: "Prețuri simple și flexibile",
    sub: "Plătiți doar pentru funcțiile de care aveți nevoie — construiți-vă propriul plan într-un minut.",
    fromTemplate: "de la {price}/lună",
