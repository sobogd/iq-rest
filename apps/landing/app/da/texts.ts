...
export const TEXTS: LandingTexts = {
  ...
  meta: {
    title: "Digital Menu, Køkkenskærm & Reservationer — IQ Rest",
    description:
      "Driv din restaurant fra én app: flersproget digital menu, køkkenskærm og reservationer døgnet rundt. Klar på 5 minutter. 14 dage gratis, intet kort.",
    canonical: "https://iq-rest.com/da",
    ogLocale: "da_DK",
    ogTitle: "Digital Menu, Køkkenskærm & Reservationer",
    ogDescription:
      "Driv din restaurant fra én app: flersproget digital menu, køkkenskærm og reservationer døgnet rundt. Klar på 5 minutter. 14 dage gratis, intet kort.",
  },
  ...
  pricingQuiz: {
    heading: "Byg din plan",
    sub: "Betal kun for det, du bruger. Start med menukortet og tilføj det, du har brug for.",
    ...
    menuTitle: "Digitalt menukort",
    menuHint: "Altid inkluderet",
    reservationsTitle: "Reservationer",
    reservationsHint: "Bordreservationer",
    kdsTitle: "Køkkenskærm",
    kdsHint: "Bestillinger på en køkkenskærm",
    domainTitle: "Eget domæne",
    domainHint: "Din egen webadresse",
    perMonthSuffix: "/md.",
    perYearSuffix: "/år",
    perMonthLongSuffix: "/måned",
    saveYearlyTemplate: "Spar {amount} om året med årlig fakturering",
    volumeDiscountTemplate: "{percent}% mængderabat · {count} restauranter",
    saveUpToHint: "Spar op til 50% med 5+ restauranter",
    billedYearly: "Faktureres én gang om året",
    billedMonthly: "Faktureres månedligt",
    enterprisePre: "Brug for en skræddersyet plan eller flere restauranter?",
    enterpriseCta: "Kontakt os",
    enterprisePost: "så skræddersyer vi en til dig.",
    enterpriseWa: "Hej! Jeg vil gerne have en skræddersyet plan til mine restauranter.",
  },

  pricingCta: {
    heading: "Enkle, fleksible priser",
    sub: "Betal kun for de funktioner, du har brug for — byg din egen plan på et minut.",
    fromTemplate: "fra {price}/md.",
