...
export const TEXTS: LandingTexts = {
  ...
  pricingQuiz: {
    heading: "Izveidojiet savu plānu",
    sub: "Maksājiet tikai par to, ko izmantojat. Sāciet ar ēdienkarti un pievienojiet, kas nepieciešams.",
    billingLabel: "Norēķini:",
    monthly: "Ikmēneša",
    yearly: "Ikgadējs",
    restaurantsLabel: "Restorāni:",
    fewerAria: "Mazāk restorānu",
    moreAria: "Vairāk restorānu",
    menuTitle: "Digitālā ēdienkarte",
    menuHint: "Vienmēr iekļauts",
    reservationsTitle: "Rezervācijas",
    reservationsHint: "Galdu rezervācijas",
    kdsTitle: "Virtuves ekrāns",
    kdsHint: "Pasūtījumi virtuves ekrānā",
    domainTitle: "Savs domēns",
    domainHint: "Jūsu pašu tīmekļa adrese",
    perMonthSuffix: "/mēn.",
    perYearSuffix: "/gadā",
    perMonthLongSuffix: "/mēnesī",
    saveYearlyTemplate: "Ietaupiet {amount} gadā ar ikgadēju norēķinu",
    volumeDiscountTemplate: "{percent}% apjoma atlaide · {count} restorāni",
    saveUpToHint: "Ietaupiet līdz 50% ar 5+ restorāniem",
    billedYearly: "Rēķins reizi gadā",
    billedMonthly: "Rēķins reizi mēnesī",
    enterprisePre: "Nepieciešams pielāgots plāns vai vairāk restorānu?",
    enterpriseCta: "Sazinieties ar mums",
    enterprisePost: "un mēs to pielāgosim jums.",
    enterpriseWa: "Sveiki! Es vēlētos pielāgotu plānu saviem restorāniem.",
  },

  pricingCta: {
    heading: "Vienkāršas, elastīgas cenas",
    sub: "Maksājiet tikai par funkcijām, kas jums vajadzīgas — izveidojiet savu plānu minūtē.",
    fromTemplate: "no {price}/mēn.",
