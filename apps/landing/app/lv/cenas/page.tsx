...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Cik restorānus varu pārvaldīt ar Pro?", a: "Pro ietver līdz 4 restorāniem vienā kontā, visi pārvaldāmi no viena paneļa. Vadāt lielāku grupu? Rakstiet mums WhatsApp par Enterprise plānu." },
