...
export const TEXTS: LandingTexts = {
  ...
  meta: {
    title: "Digitaal Menu, Keukenscherm & Reserveringen — IQ Rest",
    description:
    ...
    ogLocale: "nl_NL",
    ogTitle: "Digitaal Menu, Keukenscherm & Reserveringen",
    ogDescription:
      "Run je restaurant vanuit één app: meertalig digitaal menu, keukenscherm en 24/7 reserveringen. Klaar in 5 minuten. 14 dagen gratis, geen kaart.",
  },
  ...
  header: {
    ...
    navProducts: "Functies",
    navGuide: "Handleiding",
  },
  ...
  pricingQuiz: {
    heading: "Stel je abonnement samen",
    sub: "Betaal alleen voor wat je gebruikt. Begin met het menu en voeg toe wat je nodig hebt.",
    billingLabel: "Facturering:",
    monthly: "Maandelijks",
    yearly: "Jaarlijks",
    restaurantsLabel: "Restaurants:",
    fewerAria: "Minder restaurants",
    moreAria: "Meer restaurants",
    menuTitle: "Digitaal menu",
    menuHint: "Altijd inbegrepen",
    reservationsTitle: "Reserveringen",
    reservationsHint: "Tafelreserveringen",
    kdsTitle: "Keukenscherm",
    kdsHint: "Bestellingen op een keukenscherm",
    domainTitle: "Eigen domein",
    domainHint: "Je eigen webadres",
    perMonthSuffix: "/mnd",
    perYearSuffix: "/jaar",
    perMonthLongSuffix: "/maand",
    saveYearlyTemplate: "Bespaar {amount} per jaar met jaarlijkse facturering",
    volumeDiscountTemplate: "{percent}% volumekorting · {count} restaurants",
    saveUpToHint: "Bespaar tot 50% met 5+ restaurants",
    billedYearly: "Eén keer per jaar gefactureerd",
    billedMonthly: "Maandelijks gefactureerd",
    enterprisePre: "Een abonnement op maat of meer restaurants nodig?",
    enterpriseCta: "Neem contact op",
    enterprisePost: "en we stellen er een op maat voor je samen.",
    enterpriseWa: "Hallo! Ik wil graag een abonnement op maat voor mijn restaurants.",
  },

  pricingCta: {
    heading: "Eenvoudige, flexibele prijzen",
    sub: "Betaal alleen voor de functies die je nodig hebt — stel in een minuut je eigen abonnement samen.",
    fromTemplate: "vanaf {price}/mnd",
