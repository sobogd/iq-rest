...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Sa koliko restorana mogu da upravljam na Pro planu?", a: "Pro uključuje do 4 restorana pod jednim nalogom, kojima upravljate iz jednog administrativnog panela. Vodite veću grupu? Pišite nam na WhatsApp o Enterprise planu." },
