...
export const TEXTS: LandingTexts = {
  ...
  meta: {
    title: "Digitálne menu, kuchynský displej a rezervácie — IQ Rest",
    description:
      "Riaďte reštauráciu z jednej aplikácie: viacjazyčné digitálne menu, kuchynský displej a rezervácie 24/7. Hotovo za 5 minút. 14 dní zadarmo, bez karty.",
    canonical: "https://iq-rest.com/sk",
    ogLocale: "sk_SK",
    ogTitle: "Digitálne menu, kuchynský displej a rezervácie",
    ogDescription:
      "Riaďte reštauráciu z jednej aplikácie: viacjazyčné digitálne menu, kuchynský displej a rezervácie 24/7. Hotovo za 5 minút. 14 dní zadarmo, bez karty.",
  },
  ...
  pricingQuiz: {
    heading: "Zostavte si plán",
    sub: "Plaťte len za to, čo používate. Začnite s menu a pridajte, čo potrebujete.",
    billingLabel: "Fakturácia:",
    monthly: "Mesačne",
    yearly: "Ročne",
    restaurantsLabel: "Reštaurácie:",
    fewerAria: "Menej reštaurácií",
    moreAria: "Viac reštaurácií",
    menuTitle: "Digitálne menu",
    menuHint: "Vždy zahrnuté",
    reservationsTitle: "Rezervácie",
    reservationsHint: "Rezervácie stolov",
    kdsTitle: "Kuchynský displej",
    kdsHint: "Objednávky na kuchynskej obrazovke",
    domainTitle: "Vlastná doména",
    domainHint: "Vaša vlastná webová adresa",
    perMonthSuffix: "/mes",
    perYearSuffix: "/rok",
    perMonthLongSuffix: "/mesiac",
    saveYearlyTemplate: "Ušetrite {amount} ročne s ročnou fakturáciou",
    volumeDiscountTemplate: "{percent}% množstevná zľava · {count} reštaurácií",
    saveUpToHint: "Ušetrite až 50% s 5+ reštauráciami",
    billedYearly: "Fakturované raz ročne",
    billedMonthly: "Fakturované mesačne",
    enterprisePre: "Potrebujete vlastný plán alebo viac reštaurácií?",
    enterpriseCta: "Napíšte nám",
    enterprisePost: "a prispôsobíme ho pre vás.",
    enterpriseWa: "Dobrý deň! Chcel by som vlastný plán pre svoje reštaurácie.",
  },

  pricingCta: {
    heading: "Jednoduché, flexibilné ceny",
    sub: "Plaťte len za funkcie, ktoré potrebujete — zostavte si vlastný plán za minútu.",
