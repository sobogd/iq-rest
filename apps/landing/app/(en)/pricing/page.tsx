...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "How many restaurants can I manage on Pro?", a: "Pro includes up to 4 restaurants under one account, all managed from a single dashboard. Running a larger group? Message us on WhatsApp about an Enterprise plan." },
