...
export const CONTENT: FeatureContent = {
  ...
  trackPrefix: "l_it_qr",
  featureHeading: {
    heading: "Più di un QR code",
    sub: "Tutto ciò in cui una sola scansione si trasforma per i tuoi ospiti e la tua sala.",
  },
  ...
  hero: {
    headline: "Menu QR:\nscansiona e ordina.",
    cta: "Crea il menù QR",
    sub: "Il cliente scansiona il QR al tavolo, vede foto e allergeni in 35 lingue e ordina — senza app né ristampe.",
  },
