...
export const TEXTS: LandingTexts = {
  ...
  homeCtaText: "Provalo gratis",
  trust: [
    { kind: "num", value: 35, label: "Lingue del menu" },
    { kind: "text", value: "24/7", label: "Prenotazioni online" },
    { kind: "num", value: 5, suffix: " min", label: "Per attivarlo" },
    { kind: "count", label: "Ristoranti con noi" },
  ],
  ...
  featureHighlights: {
    heading: "Tutto incluso",
    sub: "Le funzioni che trasformano gli ospiti in ordini, in ogni piano e senza costi extra.",
  },
  ...
  pricingQuiz: {
    heading: "Crea il tuo piano",
    sub: "Paghi solo per ciò che usi. Inizia dal menu e aggiungi ciò che ti serve.",
    billingLabel: "Fatturazione:",
    monthly: "Mensile",
    yearly: "Annuale",
    restaurantsLabel: "Ristoranti:",
    fewerAria: "Meno ristoranti",
    moreAria: "Più ristoranti",
    menuTitle: "Menu digitale",
    menuHint: "Sempre incluso",
    reservationsTitle: "Prenotazioni",
    reservationsHint: "Prenotazioni dei tavoli",
    kdsTitle: "Monitor cucina",
    kdsHint: "Ordini su uno schermo in cucina",
    domainTitle: "Dominio personalizzato",
    domainHint: "Il tuo indirizzo web",
    perMonthSuffix: "/mese",
    perYearSuffix: "/anno",
    perMonthLongSuffix: "/mese",
    saveYearlyTemplate: "Risparmia {amount} all'anno con la fatturazione annuale",
    volumeDiscountTemplate: "{percent}% di sconto sul volume · {count} ristoranti",
    saveUpToHint: "Risparmia fino al 50% con 5+ ristoranti",
    billedYearly: "Fatturato una volta all'anno",
    billedMonthly: "Fatturato mensilmente",
    enterprisePre: "Ti serve un piano su misura o più ristoranti?",
    enterpriseCta: "Parla con noi",
    enterprisePost: "e lo creeremo su misura per te.",
    enterpriseWa: "Ciao! Vorrei un piano su misura per i miei ristoranti.",
  },

  pricingCta: {
    heading: "Prezzi semplici e flessibili",
    sub: "Paghi solo per le funzioni che ti servono — crea il tuo piano in un minuto.",
    fromTemplate: "da {price}/mese",
    button: "Calcola il tuo piano",
  },
  ...
  pricingHero: {
    ...
    plans: {
      basic: {
        name: "Basic",
        tagline: "Menu digitale e traduzione AI. Online in 5 minuti.",
        features: [
      ...
      pro: {
        name: "Pro",
        tagline: "Controllo completo del ristorante: ordini, cucina e prenotazioni.",
        features: [
