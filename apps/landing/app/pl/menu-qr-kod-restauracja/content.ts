...
export const CONTENT: FeatureContent = {
  ...
  trackPrefix: "l_pl_qr",
  featureHeading: {
    heading: "To nie tylko kod QR",
    sub: "Wszystko, w co jedno zeskanowanie zamienia się dla gości i dla obsługi.",
  },
  ...
  hero: {
    headline: "Menu QR:\nskanuj i zamawiaj.",
    cta: "Utwórz menu QR",
    sub: "Gość skanuje QR na stole, widzi zdjęcia i alergeny w 35 językach i zamawia — bez aplikacji.",
  },
