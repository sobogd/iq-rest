...
export const TEXTS: LandingTexts = {
  ...
  meta: {
    title: "Menu Cyfrowe, Ekran Kuchni i Rezerwacje — IQ Rest",
    description:
      "Zarządzaj restauracją z jednej aplikacji: wielojęzyczne menu cyfrowe, ekran kuchni i rezerwacje 24/7. Gotowe w 5 minut. 14 dni za darmo, bez karty.",
    canonical: "https://iq-rest.com/pl",
    ogLocale: "pl_PL",
    ogTitle: "Menu Cyfrowe, Ekran Kuchni i Rezerwacje",
    ogDescription:
      "Zarządzaj restauracją z jednej aplikacji: wielojęzyczne menu cyfrowe, ekran kuchni i rezerwacje 24/7. Gotowe w 5 minut. 14 dni za darmo, bez karty.",
  },
  ...
  pricingQuiz: {
    heading: "Zbuduj swój plan",
    sub: "Płać tylko za to, czego używasz. Zacznij od menu i dodaj to, czego potrzebujesz.",
    billingLabel: "Rozliczenie:",
    monthly: "Miesięczny",
    yearly: "Roczny",
    restaurantsLabel: "Restauracje:",
    fewerAria: "Mniej restauracji",
    moreAria: "Więcej restauracji",
    menuTitle: "Cyfrowe menu",
    menuHint: "Zawsze w zestawie",
    reservationsTitle: "Rezerwacje",
    reservationsHint: "Rezerwacje stolików",
    kdsTitle: "Ekran kuchni",
    kdsHint: "Zamówienia na ekranie kuchni",
    domainTitle: "Własna domena",
    domainHint: "Twój własny adres internetowy",
    perMonthSuffix: "/mies.",
    perYearSuffix: "/rok",
    perMonthLongSuffix: "/miesiąc",
    saveYearlyTemplate: "Zaoszczędź {amount} rocznie przy rozliczeniu rocznym",
    volumeDiscountTemplate: "{percent}% rabatu ilościowego · {count} restauracji",
    saveUpToHint: "Zaoszczędź do 50% przy 5+ restauracjach",
    billedYearly: "Rozliczane raz w roku",
    billedMonthly: "Rozliczane co miesiąc",
    enterprisePre: "Potrzebujesz indywidualnego planu lub więcej restauracji?",
    enterpriseCta: "Napisz do nas",
    enterprisePost: "a dopasujemy go dla Ciebie.",
    enterpriseWa: "Cześć! Chciałbym indywidualny plan dla moich restauracji.",
  },

  pricingCta: {
    heading: "Proste, elastyczne ceny",
    sub: "Płać tylko za funkcje, których potrzebujesz — zbuduj własny plan w minutę.",
    fromTemplate: "od {price}/mies.",
