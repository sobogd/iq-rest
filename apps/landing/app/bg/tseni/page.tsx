...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Колко ресторанта мога да управлявам с Pro?", a: "Pro включва до 4 ресторанта в един акаунт, всички управлявани от един панел. Управлявате по-голяма група? Пишете ни в WhatsApp за план Enterprise." },
