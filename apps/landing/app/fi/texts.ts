...
export const TEXTS: LandingTexts = {
  ...
  pricingQuiz: {
    heading: "Rakenna pakettisi",
    sub: "Maksa vain siitä, mitä käytät. Aloita ruokalistalla ja lisää tarvitsemasi.",
    billingLabel: "Laskutus:",
    monthly: "Kuukausittain",
    yearly: "Vuosittain",
    restaurantsLabel: "Ravintolat:",
    fewerAria: "Vähemmän ravintoloita",
    moreAria: "Enemmän ravintoloita",
    menuTitle: "Digitaalinen ruokalista",
    menuHint: "Aina mukana",
    reservationsTitle: "Varaukset",
    reservationsHint: "Pöytävaraukset",
    kdsTitle: "Keittiönäyttö",
    kdsHint: "Tilaukset keittiönäytöllä",
    domainTitle: "Oma verkkotunnus",
    domainHint: "Oma verkko-osoitteesi",
    perMonthSuffix: "/kk",
    perYearSuffix: "/vuosi",
    perMonthLongSuffix: "/kuukausi",
    saveYearlyTemplate: "Säästä {amount} vuodessa vuosilaskutuksella",
    volumeDiscountTemplate: "{percent}% määräalennus · {count} ravintolaa",
    saveUpToHint: "Säästä jopa 50% 5+ ravintolalla",
    billedYearly: "Laskutetaan kerran vuodessa",
    billedMonthly: "Laskutetaan kuukausittain",
    enterprisePre: "Tarvitsetko räätälöidyn paketin tai lisää ravintoloita?",
    enterpriseCta: "Ota yhteyttä",
    enterprisePost: "niin räätälöimme sinulle sopivan.",
    enterpriseWa: "Hei! Haluaisin räätälöidyn paketin ravintoloilleni.",
  },

  pricingCta: {
    heading: "Selkeät, joustavat hinnat",
    sub: "Maksa vain tarvitsemistasi ominaisuuksista — rakenna oma pakettisi minuutissa.",
    fromTemplate: "alkaen {price}/kk",
