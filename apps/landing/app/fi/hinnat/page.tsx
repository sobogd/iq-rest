...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Kuinka montaa ravintolaa voin hallita Pro-paketilla?", a: "Pro sisältää enintään 4 ravintolaa yhdellä tilillä, ja kaikkia hallitaan yhdestä hallintapaneelista. Onko sinulla suurempi ketju? Ota meihin yhteyttä WhatsAppissa Enterprise-paketista." },
