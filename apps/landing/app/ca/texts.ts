...
export const TEXTS: LandingTexts = {
  ...
  meta: {
    title: "Carta Digital, Pantalla de Cuina i Reserves — IQ Rest",
    description:
    ...
    ogLocale: "ca_ES",
    ogTitle: "Carta Digital, Pantalla de Cuina i Reserves",
    ogDescription:
      "Gestiona el teu restaurant des d'una sola app: carta digital multilingüe, pantalla de cuina i reserves 24/7. A punt en 5 minuts. 14 dies gratis, sense targeta.",
  },
  ...
  pricingQuiz: {
    heading: "Munta el teu pla",
    sub: "Paga només pel que utilitzes. Comença amb el menú i afegeix el que necessitis.",
    billingLabel: "Facturació:",
    monthly: "Mensual",
    yearly: "Anual",
    restaurantsLabel: "Restaurants:",
    fewerAria: "Menys restaurants",
    moreAria: "Més restaurants",
    menuTitle: "Menú digital",
    menuHint: "Sempre inclòs",
    reservationsTitle: "Reserves",
    reservationsHint: "Reserves de taula",
    kdsTitle: "Pantalla de cuina",
    kdsHint: "Comandes en una pantalla de cuina",
    domainTitle: "Domini propi",
    domainHint: "La teva pròpia adreça web",
    perMonthSuffix: "/mes",
    perYearSuffix: "/any",
    perMonthLongSuffix: "/mes",
    saveYearlyTemplate: "Estalvia {amount} l'any amb la facturació anual",
    volumeDiscountTemplate: "{percent}% de descompte per volum · {count} restaurants",
    saveUpToHint: "Estalvia fins a un 50% amb 5+ restaurants",
    billedYearly: "Facturació un cop l'any",
    billedMonthly: "Facturació mensual",
    enterprisePre: "Necessites un pla a mida o més restaurants?",
    enterpriseCta: "Parla amb nosaltres",
    enterprisePost: "i te'n prepararem un a mida.",
    enterpriseWa: "Hola! M'agradaria un pla a mida per als meus restaurants.",
  },

  pricingCta: {
    heading: "Preus senzills i flexibles",
    sub: "Paga només per les funcions que necessites — munta el teu propi pla en un minut.",
    fromTemplate: "des de {price}/mes",
