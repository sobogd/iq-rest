...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Quants restaurants puc gestionar amb Pro?", a: "Pro inclou fins a 4 restaurants sota un sol compte, tots gestionats des d'un únic panell. Gestiones un grup més gran? Escriu-nos per WhatsApp sobre un pla Enterprise." },
