...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Kolik restaurací mohu spravovat s Pro?", a: "Pro zahrnuje až 4 restaurace pod jedním účtem, všechny spravované z jednoho panelu. Provozujete větší skupinu? Napište nám na WhatsApp ohledně plánu Enterprise." },
