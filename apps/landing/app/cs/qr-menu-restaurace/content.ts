...
export const CONTENT: FeatureContent = {
  ...
  hero: {
    ...
    sub: "IQ Rest QR menu: Hosté skenují a prohlížejí jídelní lístek s fotkami, alergeny a cenami. Automatický překlad do 35 jazyků. Žádné aplikace, žádné přetiskování.",
  },
