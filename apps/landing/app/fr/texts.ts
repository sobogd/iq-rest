...
export const TEXTS: LandingTexts = {
  ...
  meta: {
    title: "Menu Digital, Écran Cuisine & Réservations — IQ Rest",
    description:
      "Gérez votre restaurant depuis une seule app : menu digital multilingue, écran cuisine et réservations 24/7. Prêt en 5 minutes. 14 jours gratuits, sans carte.",
    canonical: "https://iq-rest.com/fr",
    ogLocale: 'fr_FR',
    ogTitle: "Menu Digital, Écran Cuisine & Réservations",
    ogDescription:
      "Gérez votre restaurant depuis une seule app : menu digital multilingue, écran cuisine et réservations 24/7. Prêt en 5 minutes. 14 jours gratuits, sans carte.",
  },
  ...
  pricingQuiz: {
    heading: "Composez votre forfait",
    sub: "Payez seulement ce que vous utilisez. Commencez par le menu et ajoutez ce dont vous avez besoin.",
    billingLabel: "Facturation :",
    monthly: "Mensuel",
    yearly: "Annuel",
    restaurantsLabel: "Restaurants :",
    fewerAria: "Moins de restaurants",
    moreAria: "Plus de restaurants",
    menuTitle: "Menu digital",
    menuHint: "Toujours inclus",
    reservationsTitle: "Réservations",
    reservationsHint: "Réservations de tables",
    kdsTitle: "Écran cuisine",
    kdsHint: "Commandes sur un écran en cuisine",
    domainTitle: "Domaine personnalisé",
    domainHint: "Votre propre adresse web",
    perMonthSuffix: "/mois",
    perYearSuffix: "/an",
    perMonthLongSuffix: "/mois",
    saveYearlyTemplate: "Économisez {amount} par an avec la facturation annuelle",
    volumeDiscountTemplate: "{percent}% de remise sur volume · {count} restaurants",
    saveUpToHint: "Économisez jusqu'à 50% avec 5+ restaurants",
    billedYearly: "Facturé une fois par an",
    billedMonthly: "Facturé mensuellement",
    enterprisePre: "Besoin d'un forfait sur mesure ou de plus de restaurants ?",
    enterpriseCta: "Parlez-nous",
    enterprisePost: "et nous le créerons sur mesure pour vous.",
    enterpriseWa: "Bonjour ! J'aimerais un forfait sur mesure pour mes restaurants.",
  },

  pricingCta: {
    heading: "Des tarifs simples et flexibles",
    sub: "Payez seulement les fonctionnalités dont vous avez besoin — composez votre forfait en une minute.",
    fromTemplate: "à partir de {price}/mois",
