...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Combien de restaurants puis-je gérer avec Pro ?", a: "Pro comprend jusqu'à 4 restaurants sous un seul compte, tous gérés depuis un tableau de bord unique. Vous gérez un groupe plus grand ? Écrivez-nous sur WhatsApp au sujet d'un plan Enterprise." },
