...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "¿Cuántos restaurantes puedo gestionar con Pro?", a: "Pro incluye hasta 4 restaurantes en una sola cuenta, todos gestionados desde un único panel. ¿Tienes un grupo más grande? Escríbenos por WhatsApp sobre un plan Enterprise." },
