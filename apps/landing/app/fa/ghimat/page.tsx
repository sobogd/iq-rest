...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "با Pro چند رستوران می‌توانم مدیریت کنم؟", a: "Pro شامل حداکثر ۴ رستوران در یک حساب است که همه از یک داشبورد واحد مدیریت می‌شوند. گروه بزرگ‌تری دارید؟ درباره طرح Enterprise در WhatsApp به ما پیام دهید." },
