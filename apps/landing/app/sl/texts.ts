...
export const TEXTS: LandingTexts = {
  ...
  meta: {
    title: "Digitalni meni, kuhinjski zaslon in rezervacije — IQ Rest",
    description:
    ...
    ogLocale: "sl_SI",
    ogTitle: "Digitalni meni, kuhinjski zaslon in rezervacije",
    ogDescription:
      "Vodite restavracijo iz ene aplikacije: večjezični digitalni meni, kuhinjski zaslon in rezervacije 24/7. Pripravljeno v 5 minutah. 14 dni brezplačno, brez kartice.",
  },
  ...
  pricingQuiz: {
    heading: "Sestavite svoj paket",
    sub: "Plačajte samo za tisto, kar uporabljate. Začnite z menijem in dodajte, kar potrebujete.",
    billingLabel: "Obračun:",
    monthly: "Mesečno",
    yearly: "Letno",
    restaurantsLabel: "Restavracije:",
    fewerAria: "Manj restavracij",
    moreAria: "Več restavracij",
    menuTitle: "Digitalni meni",
    menuHint: "Vedno vključeno",
    reservationsTitle: "Rezervacije",
    reservationsHint: "Rezervacije miz",
    kdsTitle: "Kuhinjski zaslon",
    kdsHint: "Naročila na kuhinjskem zaslonu",
    domainTitle: "Domena po meri",
    domainHint: "Vaš lasten spletni naslov",
    perMonthSuffix: "/mes.",
    perYearSuffix: "/leto",
    perMonthLongSuffix: "/mesec",
    saveYearlyTemplate: "Prihranite {amount} na leto z letnim obračunom",
    volumeDiscountTemplate: "{percent} % količinski popust · {count} restavracij",
    saveUpToHint: "Prihranite do 50 % s 5+ restavracijami",
    billedYearly: "Obračunano enkrat letno",
    billedMonthly: "Obračunano mesečno",
    enterprisePre: "Potrebujete paket po meri ali več restavracij?",
    enterpriseCta: "Pišite nam",
    enterprisePost: "in vam ga prilagodimo.",
    enterpriseWa: "Pozdravljeni! Rad bi paket po meri za svoje restavracije.",
  },

  pricingCta: {
    heading: "Preproste, prilagodljive cene",
    sub: "Plačajte samo za funkcije, ki jih potrebujete — sestavite svoj paket v minuti.",
