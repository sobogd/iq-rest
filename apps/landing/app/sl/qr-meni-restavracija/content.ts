...
export const CONTENT: FeatureContent = {
  ...
  trackPrefix: "l_sl_qr",
  featureHeading: {
    heading: "Ne le koda QR",
    sub: "Vse, v kar se en sken spremeni za vaše goste in vašo strežbo.",
  },
  ...
  hero: {
    headline: "QR meni:\nskeniraj in naroči.",
    cta: "Ustvari QR meni",
    sub: "Gost skenira QR na mizi, vidi fotografije in alergene v 35 jezikih ter naroči — brez aplikacije.",
  },
