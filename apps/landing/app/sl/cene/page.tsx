...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Koliko restavracij lahko upravljam v paketu Pro?", a: "Pro vključuje do 4 restavracije v enem računu, vse upravljate iz ene same skrbniške plošče. Vodite večjo skupino? Pišite nam na WhatsApp o paketu Enterprise." },
