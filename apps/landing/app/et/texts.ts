...
export const TEXTS: LandingTexts = {
  ...
  meta: {
    title: "Digitaalne menüü, köögiekraan ja broneeringud — IQ Rest",
    description:
    ...
    ogLocale: "et_EE",
    ogTitle: "Digitaalne menüü, köögiekraan ja broneeringud",
    ogDescription:
      "Juhi restorani ühest rakendusest: mitmekeelne digitaalne menüü, köögiekraan ja broneeringud ööpäev läbi. Valmis 5 minutiga. 14 päeva tasuta, kaardita.",
  },
  ...
  pricingQuiz: {
    heading: "Koosta oma pakett",
    sub: "Maksa ainult selle eest, mida kasutad. Alusta menüüst ja lisa, mida vajad.",
    billingLabel: "Arveldus:",
    monthly: "Kuus",
    yearly: "Aastas",
    restaurantsLabel: "Restoranid:",
    fewerAria: "Vähem restorane",
    moreAria: "Rohkem restorane",
    menuTitle: "Digitaalne menüü",
    menuHint: "Alati kaasas",
    reservationsTitle: "Broneeringud",
    reservationsHint: "Lauabroneeringud",
    kdsTitle: "Köögiekraan",
    kdsHint: "Tellimused köögiekraanil",
    domainTitle: "Oma domeen",
    domainHint: "Sinu enda veebiaadress",
    perMonthSuffix: "/k",
    perYearSuffix: "/a",
    perMonthLongSuffix: "/kuus",
    saveYearlyTemplate: "Säästa aastas {amount} aastase arveldusega",
    volumeDiscountTemplate: "{percent}% mahuallahindlus · {count} restorani",
    saveUpToHint: "Säästa kuni 50% 5+ restoraniga",
    billedYearly: "Arveldatakse kord aastas",
    billedMonthly: "Arveldatakse kuus",
    enterprisePre: "Vajad eripaketti või rohkem restorane?",
    enterpriseCta: "Võta meiega ühendust",
    enterprisePost: "ja koostame sulle sobiva.",
    enterpriseWa: "Tere! Sooviksin oma restoranidele eripaketti.",
  },

  pricingCta: {
    heading: "Lihtsad, paindlikud hinnad",
    sub: "Maksa ainult vajalike funktsioonide eest — koosta oma pakett minutiga.",
    fromTemplate: "alates {price}/k",
