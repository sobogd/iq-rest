...
export const TEXTS: LandingTexts = {
  ...
  pricingQuiz: {
    heading: "Állítsd össze a csomagod",
    sub: "Csak azért fizess, amit használsz. Kezdd az étlappal, és add hozzá, amire szükséged van.",
    billingLabel: "Számlázás:",
    monthly: "Havi",
    yearly: "Éves",
    restaurantsLabel: "Éttermek:",
    fewerAria: "Kevesebb étterem",
    moreAria: "Több étterem",
    menuTitle: "Digitális étlap",
    menuHint: "Mindig benne van",
    reservationsTitle: "Foglalások",
    reservationsHint: "Asztalfoglalások",
    kdsTitle: "Konyhai kijelző",
    kdsHint: "Rendelések a konyhai kijelzőn",
    domainTitle: "Saját domain",
    domainHint: "Saját webcím",
    perMonthSuffix: "/hó",
    perYearSuffix: "/év",
    perMonthLongSuffix: "/hónap",
    saveYearlyTemplate: "Spórolj {amount}-t évente az éves számlázással",
    volumeDiscountTemplate: "{percent}% mennyiségi kedvezmény · {count} étterem",
    saveUpToHint: "Spórolj akár 50%-ot 5+ étteremmel",
    billedYearly: "Évente egyszer számlázva",
    billedMonthly: "Havonta számlázva",
    enterprisePre: "Egyedi csomagra vagy több étteremre van szükséged?",
    enterpriseCta: "Írj nekünk",
    enterprisePost: "és személyre szabjuk neked.",
    enterpriseWa: "Szia! Egyedi csomagot szeretnék az éttermeimhez.",
  },

  pricingCta: {
    heading: "Egyszerű, rugalmas árak",
    sub: "Csak a szükséges funkciókért fizess — állítsd össze a saját csomagod egy perc alatt.",
    fromTemplate: "{price}/hó-tól",
