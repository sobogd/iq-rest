...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Pro에서 몇 개의 레스토랑을 관리할 수 있습니까?", a: "Pro는 하나의 계정으로 최대 4개 레스토랑을 포함하며, 모두 단일 대시보드에서 관리됩니다. 더 큰 그룹을 운영하시나요? Enterprise 요금제에 대해 WhatsApp으로 문의하세요." },
