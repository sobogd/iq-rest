...
export const TEXTS: LandingTexts = {
  ...
  pricingQuiz: {
    heading: "플랜 구성",
    sub: "사용하는 만큼만 지불하세요. 메뉴로 시작해 필요한 것을 추가하세요.",
    billingLabel: "청구:",
    monthly: "월간",
    yearly: "연간",
    ...
    menuTitle: "디지털 메뉴",
    menuHint: "항상 포함",
    reservationsTitle: "예약",
    reservationsHint: "테이블 예약",
    kdsTitle: "주방 디스플레이",
    kdsHint: "주방 화면의 주문",
    domainTitle: "맞춤 도메인",
    domainHint: "나만의 웹 주소",
    perMonthSuffix: "/월",
    perYearSuffix: "/년",
    perMonthLongSuffix: "/월",
    saveYearlyTemplate: "연간 청구로 연 {amount} 절약",
    volumeDiscountTemplate: "{percent}% 대량 할인 · {count}개 레스토랑",
    saveUpToHint: "레스토랑 5곳 이상이면 최대 50% 절약",
    billedYearly: "연 1회 청구",
    billedMonthly: "월간 청구",
    enterprisePre: "맞춤 플랜이나 레스토랑이 더 필요하신가요?",
    enterpriseCta: "문의하기",
    enterprisePost: "맞춤형으로 준비해 드리겠습니다.",
    enterpriseWa: "안녕하세요! 제 레스토랑을 위한 맞춤 플랜을 원합니다.",
  },

  pricingCta: {
    heading: "간단하고 유연한 요금",
    sub: "필요한 기능만 지불하세요 — 1분 만에 나만의 플랜을 구성하세요.",
    fromTemplate: "{price}/월부터",
    button: "플랜 계산하기",
  },
