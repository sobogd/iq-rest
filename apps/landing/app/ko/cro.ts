...
export const CRO: CroCopy = {
  hero: {
    ...
    title: "당신의 매장을 디지털로",
    titleAccent: "5분 만에",
    sub: "디지털 메뉴, 주방 디스플레이, 24/7 예약 — 매장에 필요한 모든 것이 5분 만에.",
  },
  ...
  platform: {
    hardwareTitle: "보유하신 장비로 사용하세요",
    hardwareSub: "저희 장비 구매를 강요하지 않습니다. 이미 가지고 계신 스마트폰, 태블릿, 컴퓨터를 그대로 사용하세요.",
    anywhereTitle: "어디서나 작동",
    anywhereSub: "스마트폰, 태블릿, 노트북, PC. Android, iOS, Windows, Mac, Linux. 모든 최신 브라우저에서 설치 없이 작동합니다.",
  },

  activities: {
    heading: "하나의 시스템으로,",
    headingAccent: "레스토랑 전체를.",
    sub: "더 빠른 서비스, 더 차분한 주방, 더 낮은 비용, 그리고 손님이 기억하는 경험 — 모두 하나의 플랫폼에서.",
    groups: [
      {
        Icon: Smartphone,
        tag: "테이블에서 — 손님",
