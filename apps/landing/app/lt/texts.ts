...
export const TEXTS: LandingTexts = {
  ...
  pricingQuiz: {
    heading: "Sudarykite savo planą",
    sub: "Mokėkite tik už tai, ką naudojate. Pradėkite nuo meniu ir pridėkite, ko reikia.",
    billingLabel: "Atsiskaitymas:",
    monthly: "Mėnesinis",
    yearly: "Metinis",
    restaurantsLabel: "Restoranai:",
    fewerAria: "Mažiau restoranų",
    moreAria: "Daugiau restoranų",
    menuTitle: "Skaitmeninis meniu",
    menuHint: "Visada įskaičiuota",
    reservationsTitle: "Rezervacijos",
    reservationsHint: "Staliukų rezervacijos",
    kdsTitle: "Virtuvės ekranas",
    kdsHint: "Užsakymai virtuvės ekrane",
    domainTitle: "Nuosavas domenas",
    domainHint: "Jūsų pačių interneto adresas",
    perMonthSuffix: "/mėn.",
    perYearSuffix: "/metai",
    perMonthLongSuffix: "/mėnesį",
    saveYearlyTemplate: "Sutaupykite {amount} per metus mokėdami kasmet",
    volumeDiscountTemplate: "{percent}% nuolaida už kiekį · {count} restoranai",
    saveUpToHint: "Sutaupykite iki 50 % su 5+ restoranais",
    billedYearly: "Atsiskaitoma kartą per metus",
    billedMonthly: "Atsiskaitoma kas mėnesį",
    enterprisePre: "Reikia individualaus plano ar daugiau restoranų?",
    enterpriseCta: "Susisiekite su mumis",
    enterprisePost: "ir mes jį pritaikysime jums.",
    enterpriseWa: "Sveiki! Norėčiau individualaus plano savo restoranams.",
  },

  pricingCta: {
    heading: "Paprastos, lanksčios kainos",
    sub: "Mokėkite tik už reikalingas funkcijas — sudarykite savo planą per minutę.",
    fromTemplate: "nuo {price}/mėn.",
