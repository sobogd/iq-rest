...
export const TEXTS: LandingTexts = {
  ...
  pricingQuiz: {
    heading: "Planınızı oluşturun",
    sub: "Yalnızca kullandığınız kadar ödeyin. Menüyle başlayın ve ihtiyacınız olanı ekleyin.",
    billingLabel: "Faturalama:",
    monthly: "Aylık",
    yearly: "Yıllık",
    restaurantsLabel: "Restoranlar:",
    fewerAria: "Daha az restoran",
    moreAria: "Daha fazla restoran",
    menuTitle: "Dijital menü",
    menuHint: "Her zaman dahil",
    reservationsTitle: "Rezervasyonlar",
    reservationsHint: "Masa rezervasyonları",
    kdsTitle: "Mutfak ekranı",
    kdsHint: "Mutfak ekranında siparişler",
    domainTitle: "Özel alan adı",
    domainHint: "Kendi web adresiniz",
    perMonthSuffix: "/ay",
    perYearSuffix: "/yıl",
    perMonthLongSuffix: "/ay",
    saveYearlyTemplate: "Yıllık faturalandırmayla yılda {amount} tasarruf edin",
    volumeDiscountTemplate: "%{percent} hacim indirimi · {count} restoran",
    saveUpToHint: "5+ restoranla %50'ye varan tasarruf",
    billedYearly: "Yılda bir kez faturalanır",
    billedMonthly: "Aylık faturalanır",
    enterprisePre: "Özel bir plana veya daha fazla restorana mı ihtiyacınız var?",
    enterpriseCta: "Bize yazın",
    enterprisePost: "size özel bir plan hazırlayalım.",
    enterpriseWa: "Merhaba! Restoranlarım için özel bir plan istiyorum.",
  },

  pricingCta: {
    heading: "Basit, esnek fiyatlandırma",
    sub: "Yalnızca ihtiyacınız olan özellikler için ödeyin — kendi planınızı bir dakikada oluşturun.",
    fromTemplate: "{price}/ay'dan başlayan fiyatlarla",
