...
const PRICING_FAQ = {
  ...
  items: [
    ...
    {
      q: "Сколькими ресторанами можно управлять на Pro?",
      a: "Pro включает до 4 ресторанов в рамках одного аккаунта, всеми управляете из единой панели. У вас более крупная сеть? Напишите нам в WhatsApp о плане Enterprise.",
    },
    {
