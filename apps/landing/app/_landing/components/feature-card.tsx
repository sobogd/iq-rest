...
export function FeatureCard({ row }: { row: FeatureSubFeature }) {
  ...
  return (
    <article className="h-full flex flex-col p-5 sm:p-6 rounded-2xl bg-gradient-to-br from-primary/10 via-primary/[0.03] to-primary/[0.03] ring-1 ring-border/50 shadow-xl overflow-hidden">
