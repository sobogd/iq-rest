...
export const TEXTS: LandingTexts = {
  ...
  pricingQuiz: {
    heading: "Tóg do phlean",
    sub: "Íoc as an méid a úsáideann tú amháin. Tosaigh leis an mbiachlár agus cuir leis a bhfuil uait.",
    billingLabel: "Billeáil:",
    monthly: "Míosúil",
    yearly: "Bliantúil",
    restaurantsLabel: "Bialanna:",
    fewerAria: "Níos lú bialanna",
    moreAria: "Níos mó bialanna",
    menuTitle: "Biachlár digiteach",
    menuHint: "San áireamh i gcónaí",
    reservationsTitle: "Áirithintí",
    reservationsHint: "Áirithintí boird",
    kdsTitle: "Scáileán cistine",
    kdsHint: "Orduithe ar scáileán cistine",
    domainTitle: "Fearann saincheaptha",
    domainHint: "Do sheoladh gréasáin féin",
    perMonthSuffix: "/mí",
    perYearSuffix: "/bl",
    perMonthLongSuffix: "/mí",
    saveYearlyTemplate: "Sábháil {amount} sa bhliain le billeáil bhliantúil",
    volumeDiscountTemplate: "{percent}% lascaine toirte · {count} bialann",
    saveUpToHint: "Sábháil suas le 50% le 5+ bialann",
    billedYearly: "Billeáilte uair sa bhliain",
    billedMonthly: "Billeáilte go míosúil",
    enterprisePre: "Plean saincheaptha nó tuilleadh bialanna uait?",
    enterpriseCta: "Labhair linn",
    enterprisePost: "agus cuirfimid ceann in oiriúint duit.",
    enterpriseWa: "Dia duit! Ba mhaith liom plean saincheaptha do mo bhialanna.",
  },

  pricingCta: {
    heading: "Praghsáil shimplí, sholúbtha",
    sub: "Íoc as na gnéithe atá uait amháin — tóg do phlean féin i nóiméad.",
    fromTemplate: "ó {price}/mí",
