...
export const TEXTS: LandingTexts = {
  ...
  pricingQuiz: {
    heading: "Settu saman áskriftina",
    sub: "Borgaðu aðeins fyrir það sem þú notar. Byrjaðu á matseðlinum og bættu við því sem þú þarft.",
    billingLabel: "Rukkun:",
    monthly: "Mánaðarlega",
    yearly: "Árlega",
    restaurantsLabel: "Veitingastaðir:",
    fewerAria: "Færri veitingastaðir",
    moreAria: "Fleiri veitingastaðir",
    menuTitle: "Stafrænn matseðill",
    menuHint: "Alltaf innifalið",
    reservationsTitle: "Bókanir",
    reservationsHint: "Borðbókanir",
    kdsTitle: "Eldhússkjár",
    kdsHint: "Pantanir á eldhússkjá",
    domainTitle: "Eigið lén",
    domainHint: "Þitt eigið veffang",
    perMonthSuffix: "/mán",
    perYearSuffix: "/ári",
    perMonthLongSuffix: "/mánuði",
    saveYearlyTemplate: "Sparaðu {amount} á ári með árlegri rukkun",
    volumeDiscountTemplate: "{percent}% magnafsláttur · {count} veitingastaðir",
    saveUpToHint: "Sparaðu allt að 50% með 5+ veitingastöðum",
    billedYearly: "Rukkað einu sinni á ári",
    billedMonthly: "Rukkað mánaðarlega",
    enterprisePre: "Þarftu sérsniðna áskrift eða fleiri veitingastaði?",
    enterpriseCta: "Hafðu samband",
    enterprisePost: "og við sérsníðum hana fyrir þig.",
    enterpriseWa: "Halló! Mig langar í sérsniðna áskrift fyrir veitingastaðina mína.",
  },

  pricingCta: {
    heading: "Einföld, sveigjanleg verð",
    sub: "Borgaðu aðeins fyrir eiginleikana sem þú þarft — settu saman þína eigin áskrift á mínútu.",
    fromTemplate: "frá {price}/mán",
