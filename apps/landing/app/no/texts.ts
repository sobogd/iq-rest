...
export const TEXTS: LandingTexts = {
  ...
  trust: [
    ...
    { kind: "text", value: "24/7", label: "Nettbestillinger" },
    { kind: "num", value: 5, suffix: " min", label: "Til lansering" },
    { kind: "count", label: "Restauranter hos oss" },
  ],
  demoText: "Se demo",
  ...
  hero: {
    ...
    headline: "Digital meny for restaurant.\nLive på 5 minutter.",
  ...
  featureHighlights: {
    heading: "Alt er inkludert",
    sub: "Funksjonene som gjør gjester til bestillinger — i alle abonnementer, uten tillegg.",
  },
  ...
  pricingQuiz: {
    heading: "Bygg planen din",
    sub: "Betal bare for det du bruker. Start med menyen og legg til det du trenger.",
    billingLabel: "Fakturering:",
    monthly: "Månedlig",
    yearly: "Årlig",
    restaurantsLabel: "Restauranter:",
    fewerAria: "Færre restauranter",
    moreAria: "Flere restauranter",
    menuTitle: "Digital meny",
    menuHint: "Alltid inkludert",
    reservationsTitle: "Reservasjoner",
    reservationsHint: "Bordreservasjoner",
    kdsTitle: "Kjøkkenskjerm",
    kdsHint: "Bestillinger på en kjøkkenskjerm",
    domainTitle: "Eget domene",
    domainHint: "Din egen nettadresse",
    perMonthSuffix: "/mnd",
    perYearSuffix: "/år",
    perMonthLongSuffix: "/måned",
    saveYearlyTemplate: "Spar {amount} i året med årlig fakturering",
    volumeDiscountTemplate: "{percent}% mengderabatt · {count} restauranter",
    saveUpToHint: "Spar opptil 50% med 5+ restauranter",
    billedYearly: "Faktureres én gang i året",
    billedMonthly: "Faktureres månedlig",
    enterprisePre: "Trenger du en skreddersydd plan eller flere restauranter?",
    enterpriseCta: "Ta kontakt",
    enterprisePost: "så skreddersyr vi en for deg.",
    enterpriseWa: "Hei! Jeg vil gjerne ha en skreddersydd plan for restaurantene mine.",
  },

  pricingCta: {
    heading: "Enkle, fleksible priser",
    sub: "Betal bare for funksjonene du trenger — bygg din egen plan på et minutt.",
    fromTemplate: "fra {price}/mnd",
    button: "Beregn planen din",
  },
  ...
  pricingHero: {
    ...
    sub: "Ett månedlig gebyr. Ingen provisjon på bestillinger. Avslutt når som helst.",
    ...
    plans: {
      basic: {
        name: "Basic",
        tagline: "Digital meny og AI-oversettelse. På nett på 5 minutter.",
        features: [
      ...
      pro: {
        name: "Pro",
        tagline: "Full kontroll over restauranten: bestillinger, kjøkken og reservasjoner.",
        features: [
          "Alt i Basic",
          "Ta imot bestillinger fra menyen",
          "Servitør-app",
          "Kjøkkenskjerm (KDS)",
