...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Hvor mange restauranter kan jeg administrere på Pro?", a: "Pro inkluderer opptil 4 restauranter under én konto, alle administrert fra ett enkelt dashbord. Har du en større kjede? Send oss en melding på WhatsApp om en Enterprise-plan." },
