...
export const TEXTS: LandingTexts = {
  ...
  meta: {
    title: "Digital Meny, Köksskärm & Bokningar — IQ Rest",
    description:
    ...
    ogLocale: "sv_SE",
    ogTitle: "Digital Meny, Köksskärm & Bokningar",
    ogDescription:
      "Driv din restaurang från en app: flerspråkig digital meny, köksskärm och bokningar dygnet runt. Igång på 5 minuter. 14 dagar gratis, inget kort.",
  },
  ...
  pricingQuiz: {
    heading: "Bygg ditt abonnemang",
    sub: "Betala bara för det du använder. Börja med menyn och lägg till det du behöver.",
    billingLabel: "Fakturering:",
    monthly: "Månatlig",
    yearly: "Årlig",
    restaurantsLabel: "Restauranger:",
    fewerAria: "Färre restauranger",
    moreAria: "Fler restauranger",
    menuTitle: "Digital meny",
    menuHint: "Ingår alltid",
    reservationsTitle: "Bokningar",
    reservationsHint: "Bordsbokningar",
    kdsTitle: "Köksskärm",
    kdsHint: "Beställningar på en köksskärm",
    domainTitle: "Egen domän",
    domainHint: "Din egen webbadress",
    perMonthSuffix: "/mån",
    perYearSuffix: "/år",
    perMonthLongSuffix: "/månad",
    saveYearlyTemplate: "Spara {amount} per år med årlig fakturering",
    volumeDiscountTemplate: "{percent}% volymrabatt · {count} restauranger",
    saveUpToHint: "Spara upp till 50% med 5+ restauranger",
    billedYearly: "Faktureras en gång per år",
    billedMonthly: "Faktureras varje månad",
    enterprisePre: "Behöver du ett skräddarsytt abonnemang eller fler restauranger?",
    enterpriseCta: "Kontakta oss",
    enterprisePost: "så skräddarsyr vi ett åt dig.",
    enterpriseWa: "Hej! Jag skulle vilja ha ett skräddarsytt abonnemang för mina restauranger.",
  },

  pricingCta: {
    heading: "Enkel, flexibel prissättning",
    sub: "Betala bara för de funktioner du behöver — bygg ditt eget abonnemang på en minut.",
    fromTemplate: "från {price}/mån",
