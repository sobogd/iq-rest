...
export const CONTENT: FeatureContent = {
  ...
  trackPrefix: "l_sv_qr",
  featureHeading: {
    heading: "Inte bara en QR-kod",
    sub: "Allt som en skanning blir till för dina gäster och din servering.",
  },
  ...
  hero: {
    headline: "QR-meny: skanna\noch beställ.",
    cta: "Skapa QR-meny",
    sub: "Gästen skannar bordets QR, ser bilder och allergener på 35 språk och beställer — ingen app, ingen utskrift.",
  },
