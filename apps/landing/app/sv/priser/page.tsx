...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Hur många restauranger kan jag hantera med Pro?", a: "Pro inkluderar upp till 4 restauranger under ett konto, alla hanterade från en enda administrationspanel. Driver du en större grupp? Skriv till oss på WhatsApp om ett Enterprise-abonnemang." },
