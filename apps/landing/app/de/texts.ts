...
export const TEXTS: LandingTexts = {
  ...
  meta: {
    title: "Digitale Speisekarte, Küchendisplay & Reservierungen — IQ Rest",
    description:
    ...
    ogLocale: "de_DE",
    ogTitle: "Digitale Speisekarte, Küchendisplay & Reservierungen",
    ogDescription:
      "Führe dein Restaurant aus einer App: mehrsprachige digitale Speisekarte, Küchendisplay und Reservierungen rund um die Uhr. In 5 Minuten startklar. 14 Tage gratis, ohne Karte.",
  },
  ...
  pricingQuiz: {
    heading: "Stell deinen Tarif zusammen",
    sub: "Zahle nur für das, was du nutzt. Starte mit der Speisekarte und füge hinzu, was du brauchst.",
    billingLabel: "Abrechnung:",
    monthly: "Monatlich",
    yearly: "Jährlich",
    restaurantsLabel: "Restaurants:",
    fewerAria: "Weniger Restaurants",
    moreAria: "Mehr Restaurants",
    menuTitle: "Digitale Speisekarte",
    menuHint: "Immer inklusive",
    reservationsTitle: "Reservierungen",
    reservationsHint: "Tischreservierungen",
    kdsTitle: "Küchenmonitor",
    kdsHint: "Bestellungen auf einem Küchenbildschirm",
    domainTitle: "Eigene Domain",
    domainHint: "Deine eigene Webadresse",
    perMonthSuffix: "/Mon.",
    perYearSuffix: "/Jahr",
    perMonthLongSuffix: "/Monat",
    saveYearlyTemplate: "Spare {amount} pro Jahr mit jährlicher Abrechnung",
    volumeDiscountTemplate: "{percent}% Mengenrabatt · {count} Restaurants",
    saveUpToHint: "Spare bis zu 50% mit 5+ Restaurants",
    billedYearly: "Einmal jährlich abgerechnet",
    billedMonthly: "Monatlich abgerechnet",
    enterprisePre: "Brauchst du einen individuellen Tarif oder mehr Restaurants?",
    enterpriseCta: "Sprich mit uns",
    enterprisePost: "und wir stellen ihn passend für dich zusammen.",
    enterpriseWa: "Hallo! Ich hätte gerne einen individuellen Tarif für meine Restaurants.",
  },

  pricingCta: {
    heading: "Einfache, flexible Preise",
    sub: "Zahle nur für die Funktionen, die du brauchst — stell dir in einer Minute deinen eigenen Tarif zusammen.",
    fromTemplate: "ab {price}/Mon.",
