...
const PRICING_FAQ = {
  ...
  items: [
    ...
    { q: "Wie viele Restaurants kann ich mit Pro verwalten?", a: "Pro umfasst bis zu 4 Restaurants unter einem Konto, alle über ein einziges Dashboard verwaltet. Betreiben Sie eine größere Gruppe? Schreiben Sie uns auf WhatsApp wegen eines Enterprise-Tarifs." },
